import { DefaultTextStyles, WIDTH, HEIGHT } from "../commonAssets";

let GlobalColors = {};
let GlobalTextStyles = {};

class CommonAssets {
  constructor({ Colors, TextStyles, textStylesConfig }) {
    this.Colors = Colors;
    this.TextStyles = TextStyles || DefaultTextStyles.allTextStyles;
...
export { CommonAssets, GlobalColors, GlobalTextStyles };
