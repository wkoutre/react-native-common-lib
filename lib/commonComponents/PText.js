...
const PText = props => {
  ...
  if (!superScriptText)
    return (
      <Text
        onPress={onPress || defaultRefs.nullFunc}
        style={[
          textSizeStyle,
          localStyle.text,
          applyLetterSpacing,
  ...
  const ViewToUse = onPress ? Touchable : View;
  ...
  return (
    ...
    >
      <Text style={[textSizeStyle, localStyle.text, props.style]}>
        {props.text}
      </Text>
